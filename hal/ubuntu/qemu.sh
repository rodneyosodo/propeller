...
write_files:
  - path: /etc/default/proplet
    content: |
      ...
      PROPLET_TENANT_ID=TENANT_ID_PLACEHOLDER
      PROPLET_ENTITY_ID=ENTITY_ID_PLACEHOLDER
      PROPLET_API_KEY=API_KEY_PLACEHOLDER
...
EOF
    ...
    sed -i "s|TENANT_ID_PLACEHOLDER|${PROPLET_TENANT_ID}|g" $USER_DATA
    sed -i "s|ENTITY_ID_PLACEHOLDER|${PROPLET_ENTITY_ID}|g" $USER_DATA
    sed -i "s|API_KEY_PLACEHOLDER|${PROPLET_API_KEY}|g" $USER_DATA
