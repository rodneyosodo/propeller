...
func newService(t *testing.T) manager.Service {
	...
	svc, _, _ := manager.NewService(repos, sched, pubsub, "test-tenant", "test-channel", "", logger, nil)
...
func TestCreateTask(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			err: manager.ErrWorkflowRequired,
		},
	}
