	...
	migrations := &migrate.MemoryMigrationSource{
		Migrations: []*migrate.Migration{
			...
			},
			{
				...
				Up: []string{
					`ALTER TABLE proplets ADD COLUMN description TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN tags TEXT DEFAULT '[]'`,
					`ALTER TABLE proplets ADD COLUMN location TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN ip TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN environment TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN os TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN hostname TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN cpu_arch TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN total_memory_bytes INTEGER DEFAULT 0`,
					`ALTER TABLE proplets ADD COLUMN proplet_version TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN wasm_runtime TEXT DEFAULT ''`,
				},
				Down: []string{
					// SQLite 3.35+ supports DROP COLUMN
					`ALTER TABLE proplets DROP COLUMN wasm_runtime`,
					`ALTER TABLE proplets DROP COLUMN proplet_version`,
					`ALTER TABLE proplets DROP COLUMN total_memory_bytes`,
					`ALTER TABLE proplets DROP COLUMN cpu_arch`,
					`ALTER TABLE proplets DROP COLUMN hostname`,
					`ALTER TABLE proplets DROP COLUMN os`,
					`ALTER TABLE proplets DROP COLUMN environment`,
					`ALTER TABLE proplets DROP COLUMN ip`,
					`ALTER TABLE proplets DROP COLUMN location`,
					`ALTER TABLE proplets DROP COLUMN tags`,
					`ALTER TABLE proplets DROP COLUMN description`,
				},
			},
		},
	}
