	...
	migrations := &migrate.MemoryMigrationSource{
		Migrations: []*migrate.Migration{
			...
			},
			{
				...
				Up: []string{
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS description TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS tags JSONB DEFAULT '[]'`,
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS location TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS ip TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS environment TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS os TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS hostname TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS cpu_arch TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS total_memory_bytes BIGINT DEFAULT 0`,
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS proplet_version TEXT DEFAULT ''`,
					`ALTER TABLE proplets ADD COLUMN IF NOT EXISTS wasm_runtime TEXT DEFAULT ''`,
				},
				Down: []string{
					`ALTER TABLE proplets DROP COLUMN IF EXISTS wasm_runtime`,
					`ALTER TABLE proplets DROP COLUMN IF EXISTS proplet_version`,
					`ALTER TABLE proplets DROP COLUMN IF EXISTS total_memory_bytes`,
					`ALTER TABLE proplets DROP COLUMN IF EXISTS cpu_arch`,
					`ALTER TABLE proplets DROP COLUMN IF EXISTS hostname`,
					`ALTER TABLE proplets DROP COLUMN IF EXISTS os`,
					`ALTER TABLE proplets DROP COLUMN IF EXISTS environment`,
					`ALTER TABLE proplets DROP COLUMN IF EXISTS ip`,
					`ALTER TABLE proplets DROP COLUMN IF EXISTS location`,
					`ALTER TABLE proplets DROP COLUMN IF EXISTS tags`,
					`ALTER TABLE proplets DROP COLUMN IF EXISTS description`,
				},
			},
		},
	}
